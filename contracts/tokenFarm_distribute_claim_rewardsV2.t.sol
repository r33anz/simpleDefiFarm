...
contract TokenFarmTestDistributeRewardV2 is Test {
    ...
    function testDistribuirRecompensasExitosamente() public {
        ...
        // Obtener rewards usando struct
        (, , uint256 user1Rewards, , ) = tokenFarm.userInfo(user1);
        (, , uint256 user2Rewards, , ) = tokenFarm.userInfo(user2);
        (, , uint256 user3Rewards, , ) = tokenFarm.userInfo(user3);
    ...
    function testClaimReward() public {
        ...
        // Obtener pending rewards usando struct
        (, , uint256 pendingRewards, , ) = tokenFarm.userInfo(user1);
        ...
        (, , uint256 newPendingRewards, , ) = tokenFarm.userInfo(user1);
        assertEq(newPendingRewards, 0, "Pending rewards deberia ser 0");
        assertEq(
